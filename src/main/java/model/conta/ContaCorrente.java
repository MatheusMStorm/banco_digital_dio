...
public class ContaCorrente extends Conta {
    ...
    public void sacar(double valor) {
        saldo -= valor;
        System.out.println(String.format("Saque de R$%.2f realizado na sua conta corrente.", valor));
    }

    @Override
    public void depositar(double valor) {
        saldo += valor;
        System.out.println(String.format("Depósito de R$%.2f realizado na sua conta corrente.", valor));
    }
    ...
    public void mostrarExtrato() {
        ...
        System.out.println(String.format("Cc: %d", this.numeroConta));
